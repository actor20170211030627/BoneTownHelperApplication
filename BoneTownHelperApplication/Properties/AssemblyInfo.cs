...
[assembly: AssemblyTitle("骨头镇修改器(Bowntown TRainer)-actor2015")]     // 程序集标题（显示在程序属性的“文件说明”）
...
[assembly: AssemblyVersion("1.4.0.0")]              // 程序集版本（用于程序集引用和强命名）
[assembly: AssemblyFileVersion("1.4.0.0")]          // 文件版本（显示在程序属性的“文件版本”）
[assembly: AssemblyInformationalVersion("1.4.0.0(20260308)")]   // 信息版本（显示在“产品版本”，可包含额外信息）