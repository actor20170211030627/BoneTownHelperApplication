...
namespace BoneTownHelperApplication.Utils {
    public static class TRainerEditionXDGameHelper {
        ...
        private const string Clothing_Health = ModuleName + "+0x00354318,0xA4,0x54,0x480";
        ...
        private const string pauseDaylight = ModuleName + "+0x006575A0,0x8";
        //环境亮度
        private const string Brightness_SkyEdge_Inner_Green_Light = ModuleName + "+0x00325DD4,0x2AC";
        private const string Brightness_SkyEdge_Inner_Blue_Light = ModuleName + "+0x00325DD4,0x2B0";
        private const string Brightness_SkyEdge_Inner_Yellow_Light = ModuleName + "+0x00325DD4,0x2B4";
        private const string Brightness_SkyEdge_Light = ModuleName + "+0x003279E0,0x0,0x218";
        private const string Brightness_SkyEdge_Color = ModuleName + "+0x003279E0,0x0,0xD64";
        private const string Brightness_Ground_Green2 = ModuleName + "+0x006575A0,0x14,0x1C8";
        private const string Brightness_Ground_Purper2 = ModuleName + "+0x006575A0,0x14,0x1CC";
        private const string Brightness_Ground_Yellow2 = ModuleName + "+0x006575A0,0x14,0x1D0";
        private const string Brightness_Ground_Green = ModuleName + "+0x006575A0,0x14,0x1D4";
        private const string Brightness_Ground_Purper = ModuleName + "+0x006575A0,0x14,0x1D8";
        private const string Brightness_Ground_Yellow = ModuleName + "+0x006575A0,0x14,0x1DC";
        private const string Brightness_Object_Light = ModuleName + "+0x006577F4,0x30";
